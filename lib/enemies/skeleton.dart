...
import 'package:game_island/sprite_sheets/skeleton_sprite_sheet.dart';
import 'package:game_island/sprite_sheets/troll_sprite_sheet.dart';
import 'package:game_island/main.dart';

class Skeleton extends SimpleEnemy with ObjectCollision, UseBarLife, AutomaticRandomMovement {
  bool canMove = true;
  ...
  Skeleton(Vector2 position)
    ...
    animation: SimpleDirectionAnimation(
      idleRight: SkeletonSpriteSheet.idleRight,
      runRight: SkeletonSpriteSheet.runRight,
    ),
    speed: 30,
  ) {
    setupCollision(
